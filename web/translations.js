var Languages = {
	english: {
		...
		forgotpasswordsenttoforwarders: "The password has been sent to your forwarding addresses.",
		forgotpasswordsenttopostmaster: "Forwarding is not enabled for your account, but your mail admin has been notified about your lost password.",
		...
		forgotpassworderror: "Unknown error while resetting your password. Please try again later or ask your mail admin..",
		apploading: "Loading Data, please wait..",
		accountlocked: "I can't access my emails",
		unlockmyaccount: "Try to unlock my account..",
		accountnotlocked: "Your account is not locked on the server",
		accountunlocked: "Your account was locked! It has been unlocked now.",
		accountlockexplanation:"If you tried to log in with a wrong password multiple times in the last minutes, your account may be blocked.\
		If this is the case, you can't access any mail services on this server. You can try to unlock your Account by clicking on the link below..",
		unblockingnotenabled:"The unlocking feature is not enabled on this server.\nPlease inform your mail account administrator"
	...
	german: {
		...
		forwardersdisabled: "Email Weiterleitungen sind für den Account nicht aktiviert. Bitte an den Administrator wenden.",
		...
		forgotpasswordsenttoforwarders: "Das Passwort wurde an die hinterlegten Empfänger gesendet.",
		forgotpasswordsenttopostmaster: "Weiterleitungen sind für diesen Account nicht aktiviert, aber der Administrator wurde über das verlorene Passwort informiert.",
		...
		forgotpassworderror: "Ein Fehler ist beim Anfordern des Passworts aufgetreten. Bitte später noch einmal versuchen oder an den Administrator wenden..",
	...
	greek: {
		...
		forgotpasswordsenttoforwarders: "Ο κωδικός πρόσβασης έχει σταλεί στη διεύθυνση αποστολής σας.",
